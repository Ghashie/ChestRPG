...
<body>
  ...
  <header class="header">
    ...
    <div class="container">
     ...
     <a href="https://www.youtube.com/"><button class="btn">SOBRE</button></a> 
      <div class="dropdown">
  ...
  <main class="main-content">
    ...
    <section class="update">
      ...
      <div class="image-update">
        <div class="card">
          <img src="img/1.1.jpeg" alt="Imagem 1">
          <div class="card-text">
            <p>NOTAS DE PATCH DE CHEST RPG</p>
          </div>
          <div class="card-date">22 de jan.</div>
        </div>

        <div class="card">
          <img src="img/1.1.jpeg" alt="Imagem 2">
          <div class="card-text">
        ...
        <div class="card">
          <img src="img/1.1.jpeg" alt="Imagem 3">
          <div class="card-text">
            <p>edit doloremne nam eos quidem aliquam labore velit eveniet et. Ab, asperiores.</p>
          </div>
          <div class="card-date">22 de jan.</div>
        </div>

        <div class="card">
          <img src="img/1.1.jpeg" alt="Imagem 4">
          <div class="card-text">
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          </div>
          <div class="card-date">22 de jan.</div>
